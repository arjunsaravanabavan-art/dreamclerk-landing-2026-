...
const ROUTES = {
  ...
  "/feedback": { path: "/feedback", title: "feedback — tell us what to build next", description: "upvote features, report bugs, or just say hi. public board. we read every post and ship the most-voted requests first.", keywords: "dreamclerk feedback, feature request, bug report, roadmap" },
  "/contact": { path: "/contact", title: "contact — email, discord, or github issues", description: "hi@dreamclerk.com for support. discord for realtime help. github issues for bugs. we reply to everything within 24 hours.", keywords: "dreamclerk contact, support email, discord, github issues" },
  "/verify": { path: "/verify", title: "verify — certificate lookup", description: "enter a certificate id to verify a dreamclerk work record. public ledger shows the engineer, the sprint work, the reviews, and the completion date.", keywords: "dreamclerk verify, certificate lookup, work record verification, public cert" },
