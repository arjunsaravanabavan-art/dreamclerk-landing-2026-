...
export const BLOG_POSTS_SEO = {
  ...
  "/blog/github-profile-for-fresher-resume-the-12-minute-audit": {
    path: "/blog/github-profile-for-fresher-resume-the-12-minute-audit",
    title: "github profile for fresher resume — the 12-minute audit, with the 7 signals recruiters actually open",
    description: "recruiters spend 12 minutes on a github profile before they decide to shortlist. 7 signals drive 90% of the decision. here is the audit we run on every dreamclerk applicant's github, and what it tells us to fix.",
    keywords: "github profile for resume, fresher github audit, github profile readme, pinned repos, dreamclerk fresher, india hiring signals, open source contributions india, github 12 minute audit",
    published_at: "2026-07-01T09:00:00.000Z",
    updated_at: "2026-07-01T09:00:00.000Z",
    author: "Ananya Subramanian",
    reading_time: 11,
    tags: ["github", "fresher resume", "open source", "hiring signals"],
  },
  "/blog/linkedin-for-freshers-2026-the-profile-rewrite-that-lifts-callbacks": {
    path: "/blog/linkedin-for-freshers-2026-the-profile-rewrite-that-lifts-callbacks",
    title: "linkedin for freshers in 2026 — the profile rewrite that lifts callback rate from 0.3% to 12%",
    description: "a 45-minute linkedin rewrite that lifts callback rate from 0.3% to 12% for indian freshers. the headline, the about, the experience block, the featured section — line by line, with the data behind each change.",
    keywords: "linkedin for freshers, linkedin profile rewrite, fresher callback rate india, linkedin headline for freshers, linkedin about section software engineer, dreamclerk fresher, 40x callback lift",
    published_at: "2026-07-04T09:00:00.000Z",
    updated_at: "2026-07-04T09:00:00.000Z",
    author: "Raghav Krishnan",
    reading_time: 10,
    tags: ["linkedin", "fresher resume", "linkedin profile", "job search"],
  },
  "/blog/how-to-negotiate-salary-fresher-india-2026": {
    path: "/blog/how-to-negotiate-salary-fresher-india-2026",
    title: "how to negotiate salary as a fresher in india 2026 — the 4-sentence script and the 3 things you should never say",
    description: "74% of indian freshers accept the first salary offer. the average lift from a 4-sentence counter is +14% on base. here is the script, the data, and the 3 sentences that will end the conversation.",
    keywords: "how to negotiate salary as a fresher in india, fresher salary negotiation, sde-1 salary india, joining bonus negotiation india, fresher counter offer, dreamclerk fresher, GCC salary survey india",
    published_at: "2026-07-08T09:00:00.000Z",
    updated_at: "2026-07-08T09:00:00.000Z",
    author: "Raghav Krishnan",
    reading_time: 9,
    tags: ["salary negotiation", "fresher salary", "india", "compensation"],
  },
  "/blog/best-projects-for-fresher-resume-the-2026-shortlist": {
    path: "/blog/best-projects-for-fresher-resume-the-2026-shortlist",
    title: "best projects for fresher resume in 2026 — 7 that actually get interviews, 9 that get you filtered out",
    description: "7 projects that consistently get interviews for indian freshers in 2026, and 9 that get you filtered out at the resume screen. the data is from 287 cohort-2 applicants, scored on a 4-dimension rubric.",
    keywords: "best projects for fresher resume, projects for computer science students, cs project ideas india, capstone project ideas sde, dreamclerk fresher, fresher portfolio projects, 4-dimension rubric",
    published_at: "2026-07-11T09:00:00.000Z",
    updated_at: "2026-07-11T09:00:00.000Z",
    author: "Ananya Subramanian",
    reading_time: 12,
    tags: ["projects for resume", "fresher portfolio", "cs projects", "hiring signals"],
  },
  "/blog/ai-vs-human-recruiter-who-reviews-your-pr-in-2026": {
    path: "/blog/ai-vs-human-recruiter-who-reviews-your-pr-in-2026",
    title: "ai vs human recruiter in 2026 — who actually reads your PR, who actually decides, and what the data shows",
    description: "in 2026, 38% of engineering hiring funnels in india have an AI reviewer in the loop. the AI reads your PR. a human reads the AI's review. here is who does what, the rubric, and the data.",
    keywords: "ai vs human recruiter, ai tech lead, ai code reviewer, ai in hiring india 2026, pr review by ai, dreamclerk ai reviewer, rubric-based ai review, kappa 0.81 inter-rater",
    published_at: "2026-07-15T09:00:00.000Z",
    updated_at: "2026-07-15T09:00:00.000Z",
    author: "Ananya Subramanian",
    reading_time: 10,
    tags: ["ai recruiter", "ai tech lead", "pr review", "hiring"],
  },
};
